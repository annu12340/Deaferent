  ...
  _createClass(Main, [{
    ...
    value: function createPredictBtn() {
      ...
      predButton.addEventListener('mousedown', function () {
        ...
        if (Math.max.apply(Math, _toConsumableArray(exampleCount)) > 0) {
          ...
          if (exampleCount[0] == 0) {
            alert('You haven\'t added examples for the wake word eliza');
            return;
          }
          ...
          _this3.textLine.innerText = "Start\n\n";
    ...
    value: function createTrainingBtn() {
      ...
      trainButton.addEventListener('mousedown', function () {
        ...
        p.innerText = 'Perform the appropriate sign while holding down the "add example" button ';
    ...
    value: function createButtonList(showBtn) {
      ...
      for (var i = 0; i < words.length; i++) {
        ...
        console.log("create btn list",i, showBtn);
      }
    }
  }, {
    key: 'createButton',
...
var TextToSpeech = function () {
  ...
  _createClass(TextToSpeech, [{
    ...
    value: function speak(word) {
      ...
      if (word != 'eliza' && this.currentPredictedWords.length == 0) {
        console.log("first word should be eliza");
        console.log(word);
        return;
      }
...
var SpeechToText = function () {
  function SpeechToText() {
    ...
    this.recognition.onend = function () {
      ...
      console.log("Status: Finished Transcribing");
...
// seedrandom will not call math.random on its own again after initialization.
